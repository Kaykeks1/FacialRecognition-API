...
# web application at http://Kaykeks.pythonanywhere.com/
...
#import sys
#
#path = '/home/Kaykeks/path/to/my/app
...
#import sys
#
## assuming your django settings file is at '/home/Kaykeks/mysite/mysite/settings.py'
## and your manage.py is is at '/home/Kaykeks/mysite/manage.py'
#path = '/home/Kaykeks/mysite'
#if path not in sys.path:
#    sys.path.append(path)
#
...
#import sys
#
## The "/home/Kaykeks" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/Kaykeks/myproject"
#path = '/home/Kaykeks/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
